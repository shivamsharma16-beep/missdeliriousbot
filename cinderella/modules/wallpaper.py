...
def wall(bot: Bot, update: Update, args):
    ...
    if not query:
        ...
        json_rep = r.get(f"https://wall.alphacoders.com/api2.0/get.php?method={WALL_API}wallpaper_info&id=865098=&method=search&term={term}").json()
